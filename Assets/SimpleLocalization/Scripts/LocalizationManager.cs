...
namespace Assets.SimpleLocalization.Scripts
{
    ...
    public static class LocalizationManager
    {
        ...
        {
            new(ELanguage.English, "en", "English"),
            new(ELanguage.Russian, "ru", "Русский"),
            new(ELanguage.Turkey, "tr", "Türkçe")
        };
        ...
        public static string Language
        {
            ...
            set
            {
                ...
                {
                    if(value == format.ISO_639_1)
                        value = format.Translated;
                }
        ...
        {
            Read();
            var keys = Dictionary[Language].Keys;
            return keys.ToArray();
        }
